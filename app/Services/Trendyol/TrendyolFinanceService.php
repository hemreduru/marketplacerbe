...
class TrendyolFinanceService implements FinanceServiceContract
{
    ...
    /**
     * Fetch data from CHE endpoint with chunking support (max 15 days range).
     */
    ...
    /**
     * Fetch cargo invoice details for deduction records.
     */
    ...
    /**
     * Sync last 15 years of data in chunks.
     */
    /**
     ...
     */
    public function getSummary(string $startDateYmd, string $endDateYmd): array
    {
        return [];
    }
}
